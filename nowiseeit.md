...
WC, a male, conducted all interviews. WC currently is a Master's student in Computer Sciences, and although he had no formal experience in qualitative studies prior to this study, he had conducted a number of qualitative interviews regarding graphical design for a three-year period before joining our research group. Since only one researcher conducted all interviews, no gender matching was attempted.
...
The methodological orientation and theory of the qualitative study followed Ground Theory, in that we did not have any pre-conceived ideas of which display method would be more effective and for which reasons. All findings emerged from the interviews and its analysis as they were conducted and analyzed.
